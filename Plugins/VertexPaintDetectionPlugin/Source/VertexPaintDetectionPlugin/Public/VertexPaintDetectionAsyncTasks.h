...
private:
	...
	bool WillAppliedColorMakeChangeOnVertex(const FColor& currentColorOnVertex, const FVector& currentNormalOnVertex, const FVertexPaintColorSettingStruct& paintColorSettings);
	...
	TArray<int> amountOfVertexPositionsAtEachLOD_Global;
	TArray<int> amountOfVerticesAtEachLOD_Global;


	bool paintResultedInChange_Global = false;
	bool triedToApplyColorOnAnyVertex_Global = false;
