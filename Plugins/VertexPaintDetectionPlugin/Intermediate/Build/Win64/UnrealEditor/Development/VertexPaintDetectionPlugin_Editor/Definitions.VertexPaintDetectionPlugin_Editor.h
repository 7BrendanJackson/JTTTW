#undef VERTEXPAINTDETECTIONPLUGIN_EDITOR_API
...
#define UE_MODULE_NAME "VertexPaintDetectionPlugin_Editor"
...
#define RAPIDJSONMODULE_API DLLIMPORT
#define GAMEPLAYTAGSEDITOR_API DLLIMPORT
#define VERTEXPAINTDETECTIONPLUGIN_EDITOR_API DLLEXPORT
